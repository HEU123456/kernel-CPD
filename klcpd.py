...
# save models
parser.add_argument('--save_path', type=str, default='./exp_simulate/jumpingmean/save_RNN',
...
for epoch in range(1, args.max_iter + 1):
    ...
    while bidx < n_batchs:
        ...
        if gen_iterations % args.eval_freq == 0:
            ...
            print(" tst_mse %.1f tst_mae %.1f tst_auc %.6f" % (tst_dict['mse'], tst_dict['mae'], tst_dict['auc']),
                  end='')
